...
public class Grid
{
    ...
    private List<Point> _chargerStructure = new List<Point>();
    ...
    public CellType this[int i, int j]
    {
        ...
        set
        {
            ...
            if (value == CellType.Charger)
            {
                _chargerStructure.Add(new Point(i, j));
            }
            _grid[i, j] = value;
        }
    }
    ...
    public Point GetRandomChargerStructurePoint()
    {
        if (_chargerStructure.Count == 0)
        {
            return null;
        }
        return _chargerStructure[UnityEngine.Random.Range(0, _chargerStructure.Count)];
    }
    ...
    internal List<Point> GetAllChargeStructure()
    {
        return _chargerStructure;
    }

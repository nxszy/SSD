...
{
    public StructurePrefabWeighted[] housesPrefabe, specialPrefabs, chargerPrefabs;
    ...
    public void PlaceCharger(Vector3Int position)
    {
        if (CheckPositionBeforePlacement(position))
        {
            placementManager.PlaceObjectOnTheMap(position, chargerPrefabs[0].prefab, CellType.Charger);
        }
    }
